...
- AI-to-print and continuous-print can use optional `BAMBU_SLICER_COMMAND` / `BAMBU_SLICER_OUTPUT_EXT` local overrides to run a verified external slicer command before queueing; the generated output is still validated before the queue accepts it.
